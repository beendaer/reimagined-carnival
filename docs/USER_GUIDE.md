...
Open [http://localhost:8000/gui](http://localhost:8000/gui) in your browser. The GUI lets you submit text feed content and view the validation output plus action results.
